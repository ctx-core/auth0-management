...
import { _auth0_audience_b, _auth0_audience_Ctx } from './_auth0_audience_b'
const key = '_auth0_management_client_credentials_body'
export interface _auth0_management_client_credentials_body_Ctx
	extends _auth0_audience_Ctx {
	_auth0_management_client_credentials_body?:_auth0_management_client_credentials_body_T
}
export const _auth0_management_client_credentials_body_b = _b<_auth0_management_client_credentials_body_Ctx, typeof key>(key, ctx=>{
