...
import { _verify_access_token_header_authorization, AUTH0_DOMAIN_b, AUTH0_DOMAIN_ctx_I } from '@ctx-core/auth0'
import { _auth0_management_token_b, _auth0_management_token_ctx_I } from './_auth0_management_token_b'
export const patch_auth0_v2_client_b:patch_auth0_v2_client_b_T = _b('patch_auth0_v2_client', (
	ctx:patch_auth0_v2_client_ctx_I
)=>{
