...
export const patch_auth0_v2_client_b:patch_auth0_v2_client_b_type = _b('patch_auth0_v2_client', (ctx)=>{
	const _auth0_management_token = _auth0_management_token_b(ctx)
	const AUTH0_DOMAIN = AUTH0_DOMAIN_b(ctx)
	return patch_auth0_v2_client as patch_auth0_v2_client_type
	async function patch_auth0_v2_client(params:patch_auth0_v2_client_params_type) {
		const {
...
export type patch_auth0_v2_client_type =
	(params:patch_auth0_v2_client_params_type)=>Promise<Response>
