...
import {
	_auth0_management_token_b, _auth0_management_token_Ctx
} from './_auth0_management_token_b'
const key = 'patch_auth0_v2_client'
export interface patch_auth0_v2_client_Ctx
	extends _auth0_management_token_Ctx,
		AUTH0_DOMAIN_Ctx {
	patch_auth0_v2_client?:patch_auth0_v2_client_T
}
export const patch_auth0_v2_client_b = _b<patch_auth0_v2_client_Ctx, typeof key>(key, ctx=>{
