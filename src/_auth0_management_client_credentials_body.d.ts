...
export declare const _auth0_management_client_credentials_body_b: import("@ctx-core/object").Be<_auth0_management_client_credentials_body_Ctx, "_auth0_management_client_credentials_body", _auth0_management_client_credentials_body_T>;
