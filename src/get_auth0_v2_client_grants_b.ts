...
import {
	_verify_access_token_header_authorization, AUTH0_DOMAIN_b, AUTH0_DOMAIN_Ctx
} from '@ctx-core/auth0'
...
export interface get_auth0_v2_client_grants_Ctx
	extends _auth0_management_token_Ctx, AUTH0_DOMAIN_Ctx {
	get_auth0_v2_client_grants?:get_auth0_v2_client_grants_T
}
export const get_auth0_v2_client_grants_b = _b<get_auth0_v2_client_grants_Ctx, typeof key>(key, ctx=>{
